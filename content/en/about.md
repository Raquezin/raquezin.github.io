...
I am a **kayaker**. I also serve as a certified **canoeing referee**. The discipline, persistence, and fairness I practice on the water are the same values I bring to my work.

## On the Keyboard

My technical interests revolve around **competitive programming**, **hackathons**, and **community building**.
...
- **Hackathons & Competitions:**
  ...
  - Other participations: HackEurope, HackUPC, NASA SpaceApps, Sputnik.

## My Builds

- [**PalistApp**](https://www.palistapp.com): A platform for tracking and viewing results, races, and competitors in Spanish canoeing/kayaking events. Built with Go, PostgreSQL, and React/TypeScript. Processed ~100k requests in 4 days.
- [**Matrix Library**](https://github.com/raquezin/matrix_library): A C implementation of a matrix library from scratch, essential for understanding linear algebra and ML algorithms.
...
- **Known behaviours:** Inbox-zero, formatting obsession, too much Linux.
